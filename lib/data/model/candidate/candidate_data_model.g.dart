...
DataData _$DataDataFromJson(Map<String, dynamic> json) => DataData(
      ...
      signatureCity: json['signatureCity'],
      ...
      reinstateOfficeCode: json['reinstateOfficeCode'],
      reinstateLeaderName: json['reinstateLeaderName'],
      reinstateLastPosition: json['reinstateLastPosition'],
      ...
      pickerFaa: json['pickerFaa'],
      pickerSimpleChecking: json['pickerSimpleChecking'],
      ptkpIsExist: json['ptkpIsExist'],
      submissionDate: json['submissionDate'] as String?,
      isCompletedFaa: json['isCompletedFaa'],
      isCompletedSimpleChecking: json['isCompletedSimpleChecking'],
      ...
      idFamilyCardNo: json['idFamilyCardNo'],
      aasiNo: json['aasiNo'],
      prevCompanyAasi: json['prevCompanyAasi'],
      ...
      supportingDoc: json['supportingDoc'] as String?,
      aauiNo: json['aauiNo'],
      ...
      tocResultInfoList: json['tocResultInfoList'] == null
          ? null
          : TocResultInfoList.fromJson(
              json['tocResultInfoList'] as Map<String, dynamic>),
...
TocResultInfoList _$TocResultInfoListFromJson(Map<String, dynamic> json) =>
    TocResultInfoList();

Map<String, dynamic> _$TocResultInfoListToJson(TocResultInfoList instance) =>
    <String, dynamic>{};
