...
//
//     final requestCandidateModel = requestCandidateModelFromJson(jsonString);

import 'package:json_annotation/json_annotation.dart';
import 'dart:convert';

part 'request_candidate_model.g.dart';

RequestCandidateModel requestCandidateModelFromJson(String str) =>
    RequestCandidateModel.fromJson(json.decode(str));

String requestCandidateModelToJson(RequestCandidateModel data) =>
    json.encode(data.toJson());

@JsonSerializable()
class RequestCandidateModel {
  ...
  RequestCandidateModel copyWith({
    String? firstName,
    String? middleName,
    String? lastName,
    String? dob,
  ...
  factory RequestCandidateModel.fromJson(Map<String, dynamic> json) =>
      _$RequestCandidateModelFromJson(json);

  Map<String, dynamic> toJson() => _$RequestCandidateModelToJson(this);
}
