                          ...
                          SingleChildScrollView(
                            child: Column(
                              ...
                              children: [
                                ...
                                CheckboxListTile(
                                  title: const Text(
                                      "KPM/Location agency sama dengan perekrut"),
                                ...
                                BlocBuilder<FaaCandidatePageBloc,
                                  ...
                                  builder: (context, state) {
                                    List<CityMasterReference> listCity = state
                                        .candidateDataModel?.data?.province != 0
                                        ? state
                                        .masterDataModel
                                        ?.masterData
                                        ?.masterReferenceAll
                                        ...
                                        ?.where((element) =>
                                    element.referTo ==
                                        state.candidateDataModel?.data?.province)
                                        .toList() ??
                                        []: state
                                        .masterDataModel
                                        ?.masterData
