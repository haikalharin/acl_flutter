...
import 'package:acl_flutter/screens/faa_form_candidate/screen/private_data_page.dart';
...
class _FaaFormCandidatePageState extends State<FaaFormCandidatePage> with TickerProviderStateMixin {
      ...
      Expanded(
        child: Form(
          ...
          child: TabBarView(
            ...
            children: [
              // Content for Tab 1
              PrivateDataPage(formKey: formKey,),
              PrivateDataPage(formKey: formKey,),
              PrivateDataPage(formKey: formKey,),
            ],
          ),
