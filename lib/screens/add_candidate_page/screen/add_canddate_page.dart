...
class _AddCandidatePageState extends State<AddCandidatePage> {
  ...
  Future<void> successDialogWindow(BuildContext context) async {
    const SuccessDialog(
      title: "Success", isProgressed: false,);
    ...
    body: BlocListener<AddCandidatePageBloc, AddCandidatePageState>(
      listener: (context, state)  {
        if (state.submitStatus.isSuccess &&
            state.message == 'success-create-register') {
          getIt<AddCandidatePageBloc>().add(AddAgentDocSubmittedEvent());
        }
        if (state.submitStatus.isSuccess &&
            state.message == 'success-send-doc') {
          successDialogWindow(context);
