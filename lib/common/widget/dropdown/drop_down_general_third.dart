...
class DropDownGeneralThird extends StatefulWidget {
  const DropDownGeneralThird(
      {Key? key,
...
class _DropDownGeneralThirdState extends State<DropDownGeneralThird> {
  CheckingstatusMasterReference? initialItem;
  bool isInit = true;

  _DropDownGeneralThirdState(this.initialItem);

  @override
  void didUpdateWidget(DropDownGeneralThird oldWidget) {
    if (isInit) {
