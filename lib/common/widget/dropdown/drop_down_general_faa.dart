...
class DropDownGeneralFaa extends StatefulWidget {
  const DropDownGeneralFaa(
      {Key? key,
  ...
  State<DropDownGeneralFaa> createState() =>
      _DropDownGeneralFaaState(initialItem);
}

class _DropDownGeneralFaaState extends State<DropDownGeneralFaa> {
  AajicityMasterReference? initialItem;
  bool isInit = true;

  _DropDownGeneralFaaState(this.initialItem);

  @override
  void didUpdateWidget(DropDownGeneralFaa oldWidget) {
    if (isInit) {
