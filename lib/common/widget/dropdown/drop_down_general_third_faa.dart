...
class DropDownGeneralThirdFaa extends StatefulWidget {
  const DropDownGeneralThirdFaa(
      {Key? key,
  ...
  @override
  State<DropDownGeneralThirdFaa> createState() =>
      _DropDownGeneralThirdFaaState(initialItem);
}

class _DropDownGeneralThirdFaaState extends State<DropDownGeneralThirdFaa> {
  CheckingstatusMasterReference? initialItem;
  bool isInit = true;

  _DropDownGeneralThirdFaaState(this.initialItem);

  @override
  void didUpdateWidget(DropDownGeneralThirdFaa oldWidget) {
    if (isInit) {
