...
class DropDownGeneralSecondFaa extends StatefulWidget {
  const DropDownGeneralSecondFaa(
      {Key? key,
  ...
  @override
  State<DropDownGeneralSecondFaa> createState() =>
      _DropDownGeneralSecondFaaState(initialItem);
}

class _DropDownGeneralSecondFaaState extends State<DropDownGeneralSecondFaa> {
  CityMasterReference? initialItem;
  bool isInit = true;

  _DropDownGeneralSecondFaaState(this.initialItem);

  @override
  void didUpdateWidget(DropDownGeneralSecondFaa oldWidget) {
    if (isInit) {
