class RegexConstants {
  ...
  static const String validatorNameRegex = r'^[a-zA-Z]+(?:[\s.]+[a-zA-Z]+)*$';
  static const String validatorUserNameRegex =
  ...
  static const String validPasswordRegexFix =
      r'^(?=.*[A-Za-z])(?=.*\d)[A-Za-z\d]{6,}$'; //Minimum eight characters, at least one letter and one number:
